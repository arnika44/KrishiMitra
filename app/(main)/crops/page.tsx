...
> = {
  en: {
    ...
    crop: "Crop",
    cropPlaceholder:
      "Example: Rice, Wheat, Maize",
    land: "Land",
    selectLandUnit:
      "Select Land Unit",
    landAmount: "Land Area",
    landAmountPlaceholder:
      "Enter land area",
    ...
    invalidLand:
      "Please enter a valid land area greater than 0.",
    acre: "Acre",
    hectare: "Hectare",
    bigha: "Bigha",
    katha: "Katha",
  ...
  hi: {
    ...
    title: "मेरी फसलें",
    subtitle:
      "हर मौसम के लिए अपनी फसल और जमीन की जानकारी जोड़ें",
    addCrop: "फसल जोड़ें",
    close: "बंद करें",
    season: "मौसम",
    ...
    crop: "फसल",
    cropPlaceholder:
      "उदाहरण: चावल, गेहूँ, मक्का",
    land: "जमीन",
    selectLandUnit:
      "जमीन की इकाई चुनें",
    landAmount: "जमीन का क्षेत्रफल",
    landAmountPlaceholder:
      "जमीन का क्षेत्रफल लिखें",
    yourCrops: "आपकी फसलें",
    noCrops:
      "अभी तक कोई फसल नहीं जोड़ी गई है।",
    firstCrop:
      "ऊपर अपनी पहली फसल जोड़ें।",
    landText: "जमीन",
    seasonText: "मौसम",
    delete: "हटाएँ",
    fillAll:
    ...
    invalidLand:
      "कृपया 0 से अधिक जमीन का सही क्षेत्रफल दर्ज करें।",
    acre: "एकड़",
    hectare: "हेक्टेयर",
    bigha: "बीघा",
    katha: "कट्ठा",
  ...
  bn: {
    ...
    title: "আমার ফসল",
    subtitle:
      "প্রতিটি মরসুমের জন্য আপনার ফসল এবং জমির তথ্য যোগ করুন",
    ...
    yourCrops: "আপনার ফসল",
    noCrops:
      "এখনও কোনো ফসল যোগ করা হয়নি।",
    firstCrop:
      "উপরে আপনার প্রথম ফসল যোগ করুন।",
    landText: "জমি",
    seasonText: "মরসুম",
    delete: "মুছে ফেলুন",
    fillAll:
    ...
    invalidLand:
      "০-এর বেশি সঠিক জমির পরিমাণ লিখুন।",
    acre: "একর",
    hectare: "হেক্টর",
    bigha: "বিঘা",
    katha: "কাঠা",
  ...
  mr: {
    ...
    title: "माझी पिके",
    subtitle:
      "प्रत्येक हंगामासाठी तुमची पिके आणि जमिनीची माहिती जोडा",
    addCrop: "पीक जोडा",
    close: "बंद करा",
    season: "हंगाम",
    ...
    crop: "पीक",
    cropPlaceholder:
      "उदाहरण: तांदूळ, गहू, मका",
    land: "जमीन",
    selectLandUnit:
      "जमिनीचे एकक निवडा",
    landAmount: "जमिनीचे क्षेत्रफळ",
    landAmountPlaceholder:
      "जमिनीचे क्षेत्रफळ लिहा",
    yourCrops: "तुमची पिके",
    noCrops:
      "अजून कोणतेही पीक जोडलेले नाही.",
    firstCrop:
      "वर तुमचे पहिले पीक जोडा.",
    landText: "जमीन",
    seasonText: "हंगाम",
    delete: "हटवा",
    fillAll:
    ...
    invalidLand:
      "कृपया 0 पेक्षा जास्त योग्य जमिनीचे क्षेत्रफळ द्या.",
    acre: "एकर",
    hectare: "हेक्टर",
    bigha: "बिघा",
    katha: "काठा",
  ...
  ta: {
    ...
    crop: "பயிர்",
    cropPlaceholder:
      "உதாரணம்: அரிசி, கோதுமை, மக்காச்சோளம்",
    land: "நிலம்",
    selectLandUnit:
      "நில அளவைத் தேர்ந்தெடுக்கவும்",
    landAmount: "நிலப்பரப்பு",
    landAmountPlaceholder:
      "நிலப்பரப்பை உள்ளிடவும்",
    yourCrops: "உங்கள் பயிர்கள்",
    noCrops:
      "இதுவரை பயிர்கள் எதுவும் சேர்க்கப்படவில்லை.",
    firstCrop:
      "மேலே உங்கள் முதல் பயிரைச் சேர்க்கவும்.",
    landText: "நிலம்",
    seasonText: "பருவம்",
    delete: "நீக்கவும்",
    fillAll:
    ...
    invalidLand:
      "0-க்கு அதிகமான சரியான நிலப்பரப்பை உள்ளிடவும்.",
    acre: "ஏக்கர்",
    hectare: "ஹெக்டேர்",
    bigha: "பிகா",
    katha: "காதா",
  ...
  te: {
    ...
    title: "నా పంటలు",
    subtitle:
      "ప్రతి సీజన్‌కు మీ పంటలు మరియు భూమి వివరాలను జోడించండి",
    ...
    crop: "పంట",
    cropPlaceholder:
      "ఉదాహరణ: వరి, గోధుమ, మొక్కజొన్న",
    land: "భూమి",
    selectLandUnit:
      "భూమి యూనిట్ ఎంచుకోండి",
    landAmount: "భూమి విస్తీర్ణం",
    landAmountPlaceholder:
      "భూమి విస్తీర్ణం నమోదు చేయండి",
    yourCrops: "మీ పంటలు",
    noCrops:
      "ఇంకా పంటలు జోడించలేదు.",
    firstCrop:
      "పైన మీ మొదటి పంటను జోడించండి.",
    landText: "భూమి",
    seasonText: "సీజన్",
    delete: "తొలగించండి",
    fillAll:
    ...
    invalidLand:
      "0 కంటే ఎక్కువ సరైన భూమి విస్తీర్ణాన్ని నమోదు చేయండి.",
    acre: "ఎకరం",
    hectare: "హెక్టారు",
    bigha: "బిఘా",
    katha: "కఠా",
  ...
  gu: {
    ...
    title: "મારા પાક",
    subtitle:
      "દરેક સિઝન માટે તમારા પાક અને જમીનની માહિતી ઉમેરો",
    addCrop: "પાક ઉમેરો",
    close: "બંધ કરો",
    season: "સિઝન",
    ...
    crop: "પાક",
    cropPlaceholder:
      "ઉદાહરણ: ચોખા, ઘઉં, મકાઈ",
    land: "જમીન",
    selectLandUnit:
      "જમીનનું એકમ પસંદ કરો",
    landAmount: "જમીનનું ક્ષેત્રફળ",
    landAmountPlaceholder:
      "જમીનનું ક્ષેત્રફળ દાખલ કરો",
    yourCrops: "તમારા પાક",
    noCrops:
      "હજુ સુધી કોઈ પાક ઉમેરવામાં આવ્યો નથી.",
    firstCrop:
      "ઉપર તમારો પ્રથમ પાક ઉમેરો.",
    landText: "જમીન",
    seasonText: "સિઝન",
    delete: "કાઢી નાખો",
    fillAll:
      "કૃપા કરીને બધી માહિતી ભરો.",
    invalidLand:
      "0 કરતાં વધુ યોગ્ય જમીનનું ક્ષેત્રફળ દાખલ કરો.",
    acre: "એકર",
    hectare: "હેક્ટર",
    bigha: "બીઘા",
    katha: "કઠા",
  ...
  kn: {
    ...
    title: "ನನ್ನ ಬೆಳೆಗಳು",
    subtitle:
      "ಪ್ರತಿ ಋತುವಿಗೆ ನಿಮ್ಮ ಬೆಳೆ ಮತ್ತು ಜಮೀನಿನ ವಿವರಗಳನ್ನು ಸೇರಿಸಿ",
    addCrop: "ಬೆಳೆ ಸೇರಿಸಿ",
    close: "ಮುಚ್ಚಿ",
    season: "ಋತು",
    ...
    crop: "ಬೆಳೆ",
    cropPlaceholder:
      "ಉದಾಹರಣೆ: ಅಕ್ಕಿ, ಗೋಧಿ, ಮೆಕ್ಕೆಜೋಳ",
    land: "ಜಮೀನು",
    selectLandUnit:
      "ಜಮೀನಿನ ಘಟಕ ಆಯ್ಕೆಮಾಡಿ",
    landAmount: "ಜಮೀನಿನ ವಿಸ್ತೀರ್ಣ",
    landAmountPlaceholder:
      "ಜಮೀನಿನ ವಿಸ್ತೀರ್ಣ ನಮೂದಿಸಿ",
    yourCrops: "ನಿಮ್ಮ ಬೆಳೆಗಳು",
    noCrops:
      "ಇನ್ನೂ ಯಾವುದೇ ಬೆಳೆಗಳನ್ನು ಸೇರಿಸಲಾಗಿಲ್ಲ.",
    firstCrop:
      "ಮೇಲೆ ನಿಮ್ಮ ಮೊದಲ ಬೆಳೆ ಸೇರಿಸಿ.",
    landText: "ಜಮೀನು",
    seasonText: "ಋತು",
    delete: "ಅಳಿಸಿ",
    fillAll:
      "ದಯವಿಟ್ಟು ಎಲ್ಲಾ ಮಾಹಿತಿಯನ್ನು ಭರ್ತಿ ಮಾಡಿ.",
    invalidLand:
      "0 ಕ್ಕಿಂತ ಹೆಚ್ಚಿನ ಸರಿಯಾದ ಜಮೀನಿನ ವಿಸ್ತೀರ್ಣ ನಮೂದಿಸಿ.",
    acre: "ಎಕರೆ",
    hectare: "ಹೆಕ್ಟೇರ್",
    bigha: "ಬಿಘಾ",
    katha: "ಕಠಾ",
  ...
  ml: {
    ...
    title: "എന്റെ വിളകൾ",
    subtitle:
      "ഓരോ സീസണിനും നിങ്ങളുടെ വിളകളും ഭൂമിയുടെ വിവരങ്ങളും ചേർക്കുക",
    ...
    crop: "വിള",
    cropPlaceholder:
      "ഉദാഹരണം: അരി, ഗോതമ്പ്, ചോളം",
    land: "ഭൂമി",
    selectLandUnit:
      "ഭൂമിയുടെ യൂണിറ്റ് തിരഞ്ഞെടുക്കുക",
    landAmount: "ഭൂവിസ്തീർണ്ണം",
    landAmountPlaceholder:
      "ഭൂവിസ്തീർണ്ണം നൽകുക",
    yourCrops: "നിങ്ങളുടെ വിളകൾ",
    noCrops:
      "ഇതുവരെ വിളകളൊന്നും ചേർത്തിട്ടില്ല.",
    firstCrop:
      "മുകളിൽ നിങ്ങളുടെ ആദ്യ വിള ചേർക്കുക.",
    landText: "ഭൂമി",
    seasonText: "സീസൺ",
    delete: "ഇല്ലാതാക്കുക",
    fillAll:
      "ദയവായി എല്ലാ വിവരങ്ങളും പൂരിപ്പിക്കുക.",
    invalidLand:
      "0-ൽ കൂടുതലുള്ള ശരിയായ ഭൂവിസ്തീർണ്ണം നൽകുക.",
    acre: "ഏക്കർ",
    hectare: "ഹെക്ടർ",
    bigha: "ബിഘ",
    katha: "കഠ",
  ...
  pa: {
    ...
    title: "ਮੇਰੀਆਂ ਫਸਲਾਂ",
    subtitle:
      "ਹਰ ਸੀਜ਼ਨ ਲਈ ਆਪਣੀਆਂ ਫਸਲਾਂ ਅਤੇ ਜ਼ਮੀਨ ਦੀ ਜਾਣਕਾਰੀ ਸ਼ਾਮਲ ਕਰੋ",
    ...
    landAmountPlaceholder:
      "ਜ਼ਮੀਨ ਦਾ ਖੇਤਰਫਲ ਦਰਜ ਕਰੋ",
    yourCrops: "ਤੁਹਾਡੀਆਂ ਫਸਲਾਂ",
    noCrops:
      "ਅਜੇ ਤੱਕ ਕੋਈ ਫਸਲ ਨਹੀਂ ਜੋੜੀ ਗਈ।",
    firstCrop:
      "ਉੱਪਰ ਆਪਣੀ ਪਹਿਲੀ ਫਸਲ ਸ਼ਾਮਲ ਕਰੋ।",
    landText: "ਜ਼ਮੀਨ",
    seasonText: "ਸੀਜ਼ਨ",
    delete: "ਮਿਟਾਓ",
    fillAll:
      "ਕਿਰਪਾ ਕਰਕੇ ਸਾਰੀ ਜਾਣਕਾਰੀ ਭਰੋ।",
    invalidLand:
      "0 ਤੋਂ ਵੱਧ ਸਹੀ ਜ਼ਮੀਨ ਦਾ ਖੇਤਰਫਲ ਦਰਜ ਕਰੋ।",
    acre: "ਏਕੜ",
    hectare: "ਹੈਕਟੇਅਰ",
    bigha: "ਬਿੱਘਾ",
    katha: "ਕੱਠਾ",
  ...
  or: {
    ...
    landAmountPlaceholder:
      "ଜମିର କ୍ଷେତ୍ରଫଳ ଦିଅନ୍ତୁ",
    yourCrops: "ଆପଣଙ୍କ ଫସଲ",
    noCrops:
      "ଏପର୍ଯ୍ୟନ୍ତ କୌଣସି ଫସଲ ଯୋଡାଯାଇନାହିଁ।",
    firstCrop:
      "ଉପରେ ଆପଣଙ୍କ ପ୍ରଥମ ଫସଲ ଯୋଡନ୍ତୁ।",
    landText: "ଜମି",
    seasonText: "ଋତୁ",
    delete: "ଡିଲିଟ୍ କରନ୍ତୁ",
    fillAll:
      "ଦୟାକରି ସମସ୍ତ ତଥ୍ୟ ପୂରଣ କରନ୍ତୁ।",
    invalidLand:
      "0 ଠାରୁ ଅଧିକ ସଠିକ୍ ଜମିର କ୍ଷେତ୍ରଫଳ ଦିଅନ୍ତୁ।",
    acre: "ଏକର",
    hectare: "ହେକ୍ଟର",
    bigha: "ବିଘା",
    katha: "କଠା",
  ...
  as: {
    ...
    title: "মোৰ শস্য",
    subtitle:
      "প্ৰতিটো ঋতুৰ বাবে আপোনাৰ শস্য আৰু মাটিৰ তথ্য যোগ কৰক",
    ...
    noCrops:
      "এতিয়ালৈ কোনো শস্য যোগ কৰা হোৱা নাই।",
    firstCrop:
      "ওপৰত আপোনাৰ প্ৰথম শস্য যোগ কৰক।",
    landText: "মাটি",
    seasonText: "ঋতু",
    delete: "মচি পেলাওক",
    fillAll:
    ...
    invalidLand:
      "0 তকৈ অধিক সঠিক মাটিৰ পৰিমাণ লিখক।",
    acre: "একৰ",
    hectare: "হেক্টৰ",
    bigha: "বিঘা",
    katha: "কঠা",
  ...
  ur: {
    ...
    title: "میری فصلیں",
    subtitle:
      "ہر موسم کے لیے اپنی فصل اور زمین کی تفصیلات شامل کریں",
    ...
    land: "زمین",
    selectLandUnit:
      "زمین کی اکائی منتخب کریں",
    landAmount: "زمین کا رقبہ",
    landAmountPlaceholder:
      "زمین کا رقبہ درج کریں",
    yourCrops: "آپ کی فصلیں",
    noCrops:
      "ابھی تک کوئی فصل شامل نہیں کی گئی۔",
    firstCrop:
      "اوپر اپنی پہلی فصل شامل کریں۔",
    landText: "زمین",
    seasonText: "موسم",
    delete: "حذف کریں",
    fillAll:
      "براہ کرم تمام معلومات درج کریں۔",
    invalidLand:
      "براہ کرم 0 سے زیادہ زمین کا درست رقبہ درج کریں۔",
    acre: "ایکڑ",
    hectare: "ہیکٹر",
    bigha: "بیگھا",
    katha: "کٹھہ",
...
export default function CropsPage() {
  ...
  /* =======================================================
     LAND UNIT TRANSLATION
  ======================================================= */

  const getLandUnitName = (
    value: LandUnit
  ) => {
    switch (value) {
      case "Acre":
